curve_collections = {
    "de": {
        ...
        "X_to_forecast": {
            ...
            "vol de imb up mw cet min15 a"          : None,
            "vol de imb down mw cet min15 a"        : None,
            ...
            "vol de cap imb up mfrr mw cet h a"     : None,
            "vol de cap imb down mfrr mw cet h a"   : None,
            "vol de cap imb up afrr mw cet h a"     : None,
            "vol de cap imb down afrr mw cet h a"   : None,
